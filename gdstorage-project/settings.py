"""
Django settings for dev-talk-project project.
...
SECRET_KEY = 'django-insecure-*%%j@zftj97$w$3n6j3xu53mz*m#hwh4(6h+ddr3_#w2_g=gc@'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'motorcycles', 'templates', 'motorcycles'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
